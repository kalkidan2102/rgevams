...
export function Navbar({
  ...
  return (
    <header className="Navbar w-full shrink-0 font-sans select-none bg-white border-b border-slate-200 text-slate-900 shadow-md">
      ...
      <div className="relative z-[60] bg-slate-100 border-b border-slate-200 text-xs py-1.5 px-4 md:px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-2.5 md:gap-0">
          ...
          <div className="flex items-center gap-2 flex-wrap justify-center">
            ...
            {/* Account Action: Sign Out for authorized users / Login for guests */}
            {!isGuest ? (
              <div className="flex items-center gap-2">
                <div className="hidden sm:flex items-center gap-1.5 bg-white px-2.5 py-1 rounded-md border border-slate-300 shadow-2xs">
                  <span className="w-2 h-2 rounded-full bg-emerald-500 shrink-0" />
                  <span className="font-semibold text-[11px] text-slate-700 truncate max-w-[130px]">
                    {userRole.name || "Authorized"}
                  </span>
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 bg-white hover:bg-rose-50 text-slate-700 hover:text-rose-700 px-2.5 py-1 rounded-md border border-slate-300 hover:border-rose-300 transition-colors cursor-pointer text-[11px] font-medium shadow-2xs"
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-1 bg-[#0085C8] hover:bg-[#0070ab] text-white font-medium text-[11px] px-2.5 py-1 rounded-md transition-colors cursor-pointer shadow-2xs border border-[#0070ab]"
      ...
      <div className="relative z-50 bg-white text-slate-900 py-3.5 px-4 md:px-6 border-b border-slate-200 overflow-visible">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            {!isGuest ? (
              <div className="relative z-50" ref={dgProfileDropdownRef}>
                <div className="flex items-center gap-2 bg-slate-50 hover:bg-slate-100/80 border-2 border-[#D48F29] rounded-xl p-1.5 pl-2.5 shadow-xs transition-all">
                  ...
                  <button
                    ...
                    type="button"
                    onClick={handleNavigateToUserDashboard}
                    className="flex items-center gap-1.5 px-3 py-1.5 bg-[#0E4A72] hover:bg-[#093552] active:scale-95 text-[#F7D08A] font-bold text-xs rounded-lg border border-[#D48F29] shadow-xs hover:shadow-md transition-all cursor-pointer shrink-0 group"
                    title={isAmharic ? `ወደ ${roleConfig.dashboardName} ሂድ` : `Go to your ${roleConfig.dashboardName}`}
                  >
                    <LayoutDashboard className="w-3.5 h-3.5 text-[#F7D08A] group-hover:scale-110 transition-transform" />
                ...
                {/* Profile Options Dropdown Menu - Styled with high elevation to float above the navbar */}
                {isDgProfileMenuOpen && (
                  <div 
                    id="dg-profile-dropdown-menu"
                    className="absolute right-0 top-[calc(100%+8px)] w-76 sm:w-80 bg-white rounded-xl shadow-2xl border border-slate-200 z-[100] py-2 text-slate-800 animate-fade-in font-sans ring-1 ring-black/10"
                  ...
                  >
                    ...
                    <div className="p-2 border-b border-slate-100">
                      <button
                        id="dg-dropdown-dashboard-btn"
                        type="button"
                        onClick={() => {
                          setIsDgProfileMenuOpen(false);
                          handleNavigateToUserDashboard();
                        }}
                        className="w-full py-2.5 px-3 rounded-lg bg-[#0E4A72] hover:bg-[#093552] text-[#F7D08A] text-xs font-bold flex items-center gap-2 transition-colors cursor-pointer shadow-xs group"
                      >
                        <LayoutDashboard className="w-4 h-4 text-[#F7D08A] group-hover:scale-110 transition-transform" />
